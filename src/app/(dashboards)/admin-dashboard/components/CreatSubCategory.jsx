...
export default function CreateSubCategory({ categories = [], onSuccess }) {
    ...
    return (
        <form onSubmit={submit} className="space-y-4">
            ...
            <div>
                <label className="font-medium">Subcategory Image *</label>
                ...
                {photo ? (
                    ...
                    <div className="p-3 border rounded-xl mt-2 cursor-pointer">
                        <input
                            type="file"
                            accept="image/*"
